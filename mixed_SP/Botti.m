classdef Botti < handle
    ...
    methods
        function obj=Botti(V,dt)
            ...
            obj.V_SR = 465.199;        % micrometre_cube (in model_parameters)
            obj.Vc   = 7012.0;        % micrometre_cube (in model_parameters)
            obj.Cm   = 7.8667e-11;   % farad (in model_parameters)
            
            obj.Nao = 154.0; % millimolar (in model_parameters)
            obj.Ko  = 4;   % millimolar (in model_parameters)
            obj.Cao = 2.0;   % millimolar (in model_parameters)
            
            obj.Ki = 150.0;   % millimolar (in model_parameters)
            
            obj.g_Na        = 9800.86868852711;
            obj.myCoefTauM  = 1;
            obj.tauINaL     = 200; 
            obj.GNaLmax     = 13.3509157535054; 
            obj.Vh_hLate    = 87.61;
            obj.g_f         = 25.9541335109086;
            obj.fNa         = 0.37;
            obj.fK          = 1 - obj.fNa;
            obj.g_CaL       = 7.44995532741049e-05;
            obj.constf2     = 1.0;
            obj.g_to        = 59.4564976228642;  
            obj.g_Ks        = 2.08556136889656;
            obj.L0           = 0.025;  
            obj.Q            = 2.3;    
            obj.g_Kr         = 16.8722;   
            ...
            obj.gamma       = 0.35;  
            obj.alpha       = 2.16659;
            obj.kNaCa       = 3450.73331808885; 
            obj.Km_K        = 1.0;  
            obj.Km_Na       = 40.0; 
            obj.PNaK        = 2.27178916268546;
            obj.KPCa        = 0.0005;   
            obj.g_PCa       = 0.456955096510698;  
            obj.g_b_Na      = 1.14;
            obj.g_b_Ca      = 0.8727264; 
            obj.VmaxUp		= 0.3226;
            obj.Kup			= 4.40435e-4;
            obj.V_leak		= 4.48209e-4;
            obj.g_irel_max	= 75.4190;
            obj.RyRa1       = 0.1034;
            obj.RyRa2       = 0.050001;
            ...
            % obj.f20=1;
            % obj.fCa0=0.997840000000000;
            % obj.Xr10=4.10050000000000e-07;
            % obj.Xr20=0.514850000000000;
            % obj.Xs0=0.0117060000000000;
            % obj.h0=0.973370000000000;
            % obj.j0=0.974170000000000;
            % obj.m0=0.00958940000000000;
            % obj.Xf0=0.512630000000000;
            % obj.q0=0.948970000000000;
            % obj.r0=0.00237220000000000;
            % obj.Nai0=14.9650000000000;
            % obj.mL0=0.000108850000000000;
            % obj.hL0=0.625550000000000;
            % obj.RyRa0=0.0981820000000000;
            % obj.RyRo0=3.62930000000000e-11;
            % obj.RyRc0=0.984730000000000;
            % obj.ua0=0.297490000000000;
            % obj.ui0=0.995440000000000;
            % obj.O0=0.00499310000000000;


            obj.CaSR0=0.039624;
            obj.Cai0=33.4412e-05;
            obj.g0=0;
            obj.d0=2.021e-05;
            obj.f10=0.63335;
            obj.f20=0.94148;
            ...
            obj.d_inf       =@(V) 1.0./(1.0+exp(-(V.*1000.0+5.9860)./7.0));
            ...
            obj.f1_inf      =@(V) 1.0./(1.0+exp((V.*1000.0+25.2260)./3.0));
            obj.constf1     =@(V,Cai,f1) ((1.0+1433.0.*(Cai-50.0*1.0e-6))*1.35).*(obj.f1_inf(V)-f1 > 0.0) + 1.0.*(obj.f1_inf(V)-f1 < 0.0);
            ...
            obj.i_K1        =@(V) obj.g_K1.*obj.Ko.^(0.4457).*1000.0.*(V-obj.E_K)./(1.0+exp(1.5.*(V.*1000.0-obj.E_K.*1000.0+3.6).*obj.F./(obj.R.*1000.0.*obj.T)));
            ...
            obj.g_Kur       =@(V) obj.coeff_Kur .* (0.005 + 0.05./(1+exp((V.*1000.0-15.0)./-13.0))); % nS/pF
            obj.ua_inf     =@(V) 1.0 ./ (1.0+exp(-(1000.0.*V+30.3)./9.6));
            obj.ui_inf     =@(V) 1.0 ./ (1.0+exp((1000.0.*V-99.45)./27.48));
            obj.alpha_ua    =@(V) 0.65 ./ (exp(-(1000.0.*V+10.0)./8.5)+exp(-(1000.0.*V-30.0)./59.0));
            obj.beta_ua     =@(V) 0.65 ./ (exp(-(1000.0.*V+82.0)./17.0)+2.5);
            obj.alpha_ui    =@(V) 1.0 ./ (21.0+exp((1000.0.*V-185.0)./28.0));
            obj.beta_ui     =@(V) exp((V.*1000.0-158.0)./16.0);
            obj.tau_ua      =@(V) obj.KQ10./(obj.alpha_ua(V)+obj.beta_ua(V));
            obj.tau_ui      =@(V) obj.KQ10./(obj.alpha_ui(V)+obj.beta_ui(V));

            obj.i_Kur       =@(V,ua,ui)  obj.g_Kur(V) .* ua.^3.0 .* ui .* (1000.0.*V-1000.0.*obj.E_K);

            obj.dO          =@(O,Cai) (1.0-O) .* obj.KCa_on .* Cai.^2.0 - O .* obj.KCa_off;
            obj.i_KCa       =@(V,O) obj.g_KCa .* O .*(1.0./(1.0 + exp((V.*1000.0 - obj.E_K.*1000.0 + 120.0)./45.0))) .* (V.*1000.0 - obj.E_K.*1000.0);
            ...
            obj.ua_o=zeros(size(V));
            obj.ui_o=zeros(size(V));
            obj.O_o=zeros(size(V));
            ...
            obj.ua_n=zeros(size(V));
            obj.ui_n=zeros(size(V));
            obj.O_n=zeros(size(V));
        ...
        function Iion=solveTimestep(obj,Vold,i)
            ...
            ua_inf_eval = obj.ua_inf(Vold);
            tau_ua_eval = obj.tau_ua(Vold);
            obj.ua_n=ua_inf_eval+(obj.ua_o-ua_inf_eval).*exp(-obj.dt./tau_ua_eval);

            ui_inf_eval = obj.ui_inf(Vold);
            tau_ui_eval = obj.tau_ui(Vold);
            obj.ui_n=ui_inf_eval+(obj.ui_o-ui_inf_eval).*exp(-obj.dt./tau_ui_eval);

            dO_eval=obj.dO(obj.O_o,obj.Cai_o);
            obj.O_n=obj.O_o+obj.dt.*dO_eval;
            ...
            i_Kur_eval=obj.i_Kur(Vold,obj.ua_n,obj.ui_n);
            i_KCa_eval=obj.i_KCa(Vold,obj.O_n);
            ...
            Iion=i_Kur_eval+i_KCa_eval+i_K1_eval+i_to_eval+i_Kr_eval+i_Ks_eval+i_CaL_eval+i_NaK_eval+i_Na_eval+i_NaL_eval+i_NaCa_eval+i_PCa_eval+i_f_eval+i_b_Na_eval+i_b_Ca_eval;
